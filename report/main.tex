...
In this paper, we extend this symbolic representation approach and explore the potential of incorporating inductive logic programming into reinforcement learning to solve the above issues.
...
ground(P) in this case  is \{p(a), q(a)\}. 
...
Where X is a set of atoms. The first step removes q  $\leftarrow$ not p, and the second step will remove not q. Thus reduct P\textsuperscript{x} is \{p, r $\leftarrow$ p.\}
\end{examp}
\label{reduct}
