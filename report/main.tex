...
\label{ilp}
Inductive Logic Programming (ILP) is a subfield of research area aimed at the intersection between machine learning and logic programming (MUGGLETON 1991). The purpose of ILP is to derive a hypothesis H that is a solution of a learning task, which coveres all positive examples and any of negative examples.
...
ASP prgorma consists of a set of rules, where each rule consists of an atom and literals.
...
Choice rule can express possible outcomes given an action choice. For example,
