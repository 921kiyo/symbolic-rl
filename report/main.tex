...
\textit{Clingo} is one of ASP solvers that executes the ASP program and returns answer sets of the programs, and we will use \textit{Clingo} for the implementation of this research. 
...
The limitation of Brave indction that cannot learn constraints as shown in the example \ref{limitation_brave}. 
