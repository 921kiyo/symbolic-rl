...
% The reason for using random exploration is that it can be used for both benchmark and ILP(RL) and thus enables us to do a fair comparison between them.
...
% \lstinputlisting[
% %   language = Prolog,
%   caption  = {Answer sets for experiment 1},
% ]{experiment1_asp.pl}
