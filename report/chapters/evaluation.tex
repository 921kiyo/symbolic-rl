...
Figure \ref{experiment2_ilasp} shows the learning convergence of inductive learning.
Similar to Experiment 1, most of inductive learning occur at the beginning, as shown in Figure \ref{experiment2_runtime}. Despite the fact that the size of the environment is the same as Experiment 1, 
...
the result of Experiment 2 shows that, the learning time per episode increases with respect to the complexity of the environment.
