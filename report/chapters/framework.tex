...
% \State \ \ \ \ \ \ Action $a$
% \State \ \ \ \ \ \ Next State $s^\prime$ = T(s,a)
...
% The communication between the environment is simple: the driver sends an action determined by ILP(RL) algorithm and receives an observation.
