...
% and the algorithm learns hypotheses, which is the valid move of the game, which is a general concept and therefore can be easily applied to a different senarios.

In simple environments, we show that an agent learns rules of the game and reaches an optimal policy faster than existing RL algorithms.
