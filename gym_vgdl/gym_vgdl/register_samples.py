...
classes = {
    ...
    'experiment2':    ['avatar',  'goal', 'portalentry', 'portalexit', 'random',
                       'straight', 'wall' ],
    'experiment3':    ['avatar',  'goal', 'portalentry', 'portalexit', 'random',
                       'straight', 'wall' ],
    'experiment3.5':  ['avatar',  'goal', 'portalentry', 'portalexit', 'random',
                       'straight', 'wall' ],
    'experiment4_before':    ['avatar',  'goal', 'portalentry', 'portalexit', 'random',
                       'straight', 'wall' ],
    'experiment4_after':    ['avatar',  'goal', 'portalentry', 'portalexit', 'random',
                       'straight', 'wall' ],
    'experiment5':    ['avatar',  'goal', 'portalentry', 'portalexit', 'random',
                       'straight', 'wall' ],
