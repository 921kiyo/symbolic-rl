%ILASP
state_after(V0) :- is_link(V0), not adjacent(down, V1, V0), state_before(V1).
...
state_after(V1) :- not is_link(V1), adjacent(down, V0, V1), state_before(V0), action(up), not wall(V1).
