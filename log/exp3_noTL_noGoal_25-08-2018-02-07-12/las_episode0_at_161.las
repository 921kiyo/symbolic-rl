...
#pos({}, {state_after((5,6)),state_after((4,7)),state_after((3,6)),state_after((4,5)),state_after((3,4)),state_after((4,5)),state_after((0,6)),state_after((1,6)),state_after((2,6)),state_after((0,8)),state_after((1,8)),state_after((2,8)),state_after((3,8))}, {state_before((4,6)).action(right).wall((5, 6)). wall((3, 6)). }).
#pos({}, {state_after((5,6)),state_after((4,7)),state_after((3,6)),state_after((4,6))}, {state_before((4,6)).action(up).wall((5, 6)). wall((3, 6)). }).
#pos({}, {state_after((5,5)),state_after((3,5)),state_after((4,4)),state_after((4,5)),state_after((4,3)),state_after((5,4)),state_after((1,5)),state_after((2,5)),state_after((3,5)),state_after((5,5)),state_after((0,6)),state_after((1,7)),state_after((2,7)),state_after((3,7)),state_after((4,7))}, {state_before((4,5)).action(down).wall((5, 5)). wall((4, 4)). }).
