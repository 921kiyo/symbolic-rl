...
#pos({}, {state_after((5,5)),state_after((4,6)),state_after((3,5)),state_after((4,4))}, {state_before((4,5)).action(right).wall((5, 5)). wall((4, 4)). }).
#pos({}, {state_after((5,5)),state_after((4,6)),state_after((3,5)),state_after((4,4))}, {state_before((4,5)).action(up).wall((5, 5)). wall((4, 4)). }).
#pos({}, {state_after((5,5)),state_after((3,5)),state_after((4,4)),state_after((4,5)),state_after((4,4)),state_after((5,4)),state_after((6,5)),state_after((2,6)),state_after((3,6)),state_after((6,6)),state_after((1,7)),state_after((2,8)),state_after((3,8)),state_after((4,8)),state_after((5,8)),state_after((6,8)),state_after((7,8))}, {state_before((4,5)).action(down).wall((5, 5)). wall((4, 4)). }).
