...
#pos({}, {state_after((1,6)),state_after((0,5)),state_after((1,4)),state_after((1,5)),state_after((1,4)),state_after((2,4)),state_after((3,4)),state_after((4,5)),state_after((0,6)),state_after((1,6)),state_after((2,6)),state_after((4,6)),state_after((0,8)),state_after((1,8)),state_after((2,8)),state_after((3,8))}, {state_before((1,5)).action(right).wall((1, 6)). wall((0, 5)). }).
#pos({}, {state_after((3,5)),state_after((2,6)),state_after((2,4)),state_after((2,5))}, {state_before((2,5)).action(left).wall((2, 6)). wall((2, 4)). }).
