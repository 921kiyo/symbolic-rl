...
#pos({state_after((3,7))}, {state_after((4,7)),state_after((3,8)),state_after((2,7)),state_after((3,6)),state_after((4,7))}, {state_before((3,7)).action(down).wall((3, 8)). wall((3, 6)). }).
