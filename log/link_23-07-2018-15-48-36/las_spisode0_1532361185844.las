...
#pos({state_after((4,4))}, {state_after((1,1)), state_after((2,1)), state_after((3,1))}, {state_before((3,4)). action(right). wall((3, 5)). }).
#pos({state_after((5,4))}, {state_after((1,1)), state_after((2,1)), state_after((3,1)), state_after((4,1))}, {state_before((4,4)). action(right). wall((4, 5)). wall((4, 3)). }).
#pos({state_after((5,4))}, {state_after((1,1)), state_after((2,1)), state_after((3,1)), state_after((4,1)), state_after((5,1))}, {state_before((5,4)). action(right). wall((6, 4)). wall((5, 5)). wall((5, 3)). }).
#pos({state_after((2,4))}, {state_after((1,1))}, {state_before((1,4)). action(right). wall((1, 5)). wall((0, 4)). }).
#pos({state_after((3,4))}, {state_after((1,1)), state_after((2,1))}, {state_before((2,4)). action(right). wall((2, 5)). wall((2, 3)). }).
#pos({state_after((4,4))}, {state_after((1,1)), state_after((2,1)), state_after((3,1))}, {state_before((3,4)). action(right). wall((3, 5)). }).
#pos({state_after((5,4))}, {state_after((1,1)), state_after((2,1)), state_after((3,1)), state_after((4,1))}, {state_before((4,4)). action(right). wall((4, 5)). wall((4, 3)). }).
