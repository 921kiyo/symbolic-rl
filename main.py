...
temp_dir = os.path.join(cf.BASE_DIR, "result_pkl/experiment3_after_noTL_noGoal")

for i in range(17,30):
    stats, stats_test,stats_ilasp = k_learning(env, 100, epsilon=0.1, record_prefix="exp3_noTL_noGoal", is_link=True)
    plotting.store_stats(stats, temp_dir, "exp3_v{}".format(str(i)))
    plotting.store_stats(stats_test, temp_dir, "exp3_test_v{}".format(str(i)))
    plotting.store_stats(stats_ilasp, temp_dir, "exp3_ilasp_v{}".format(str(i)))
